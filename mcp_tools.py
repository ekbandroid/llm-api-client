...
RULES = (
    ...
    "— напомнить, завести задание, отменить его, — сначала вызови инструмент и "
    "только потом говори «готово». Почему: «напомню через минуту» без вызова "
    "значит, что никто ничего не напомнит, а человек будет уверен в обратном.\n"
