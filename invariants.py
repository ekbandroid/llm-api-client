...
JUDGE_SYSTEM = (
    ...
    f'нарушение с id "{STAGE_VIOLATION}".\n'
    "Нарушением НЕ считается: отказ сделать запрещённое; работа самого текущего "
    "этапа и её завершение; слова «результат предъявлен», «готов к проверке», "
    "«этап выполнения завершён» и предложение перейти к следующему этапу — это "
    "нормальный конец текущего этапа, а не прыжок через него.\n"
    "Сомневаешься — нарушения нет. Помечай только то, где ответ действительно "
    "сделал работу следующего этапа.\n"
